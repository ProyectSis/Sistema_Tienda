...
public class V_nuevo_proveedor extends javax.swing.JInternalFrame {

     conexion conexion = new conexion();
    Connection cc = conexion.conectado();
    public V_nuevo_proveedor() {
 ...
 public void limpiar(){
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        try{
            String sql="INSERT INTO tbl_proveedor(VEN_NOMBRE,VEN_RUC,VEN_TELEFONO,PROV_DIRECCION,PROV_CORREO) VALUES (?,?,?,?,?)";
