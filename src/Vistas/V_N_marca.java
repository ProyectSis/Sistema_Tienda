 ...
 * @author Admin
 */
public class V_N_marca extends javax.swing.JFrame {

    /**
     * Creates new form V_N_marca
     */
    public V_N_marca() {
        initComponents();
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (txtDescripcion.getText().length() > 0) {
            marca_crud mc = new marca_crud();
            mc.nuevaMarca(txtDescripcion.getText());
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(V_N_marca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
